...
<body>
	...
	<div class="container">
		...
		<form id="formModifyPw" method="post"
			action="${pageContext.request.contextPath}/customer/on/modifyMyByPw">
			<table border="0">
				<tr>
					<td><label for="prePw">변경 전 비밀번호</label></td>
					<td><input type="password" name="prePw" id="prePw"
						placeholder="현재 비밀번호를 입력하세요"></td>
				</tr>
				<tr>
					<td><label for="newPw">변경할 비밀번호</label></td>
					<td><input type="password" name="newPw" id="newPw"
						placeholder="새로운 비밀번호를 입력하세요"></td>
				</tr>
				<tr>
