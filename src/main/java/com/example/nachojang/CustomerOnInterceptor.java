...
public class CustomerOnInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		if(session.getAttribute("loginCustomer") == null) { // 사용자가 로그인하지 않은 경우
			response.sendRedirect(request.getContextPath()+"/customer/off/customerLogin"); // staffLogin.jsp
			return false;
		}
