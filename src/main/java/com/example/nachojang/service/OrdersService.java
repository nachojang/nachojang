...
public class OrdersService {
	...
	// 세영) 전체 주문 내역 리스트 마지막 페이지
	// /staff/on/ordersList
	public Integer getLastPage(Integer rowPerPage) {
		Integer totalCount = ordersMapper.selectTotalOrders();
	...
	public Map<String, Object> getOrdersListByCustomerMail(Integer currentPage, Integer rowPerPage, String customerMail) {
		...
		Integer lastPage = this.getLastPageByCustomerMail(customerMail, rowPerPage);
		// 끝 번호가 마지막 페이지를 넘지 않도록 
		if(lastPage < endPagingNum) {
			endPagingNum = lastPage;
		}
		// 파라미터 맵을 전달하여 실제 데이터 목록을 조회
		List<Map<String, Object>> ordersList = ordersMapper.selectOrdersListByCustomerMail(paramMap);
	...
	// 세영) 전체 주문 목록
	// /staff/on/ordersList
	public Map<String, Object> getOrdersList(Integer currentPage, Integer rowPerPage) {
		...
		if(lastPage < endPagingNum) {
		 ...
		 // 파라미터 맵을 전달하여 실제 데이터 목록을 조회
		List<Map<String, Object>> ordersList = ordersMapper.selectOrdersList(paramMap);
	...
	// 세영) 고객의 주문 내역 리스트 마지막 페이지
	// /customer/on/ordersList
	public Integer getLastPageByCustomerMail(String customerMail, Integer rowPerPage) {
